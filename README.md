...
Country name, Capital city, Flag image
Each quiz round consists of 10 randomly selected questions
Answer options are generated dynamically, including one correct answer and multiple distractors
...
Display Scores per player or Overall score overview
